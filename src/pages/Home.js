...
const Home = () => (
  <div className={styles.container}>
    ...
    <p className={styles.uses}>
      ...
      heights are also measured using maths. Travelling: Distance between two
      places and time taken to travel also includes maths. The amount of time
      taken revolves around maths. Almost every work is related to maths in some
      way or another. Maths contains some conditions that need to be followed,
      and maths has several formulas that have to be learned to become a
      mathematician.
    </p>
  </div>
);
